...
/**
 * *Config Driven UI
 *  when the ui gives difffrent ui for diffrent scenario
 *  eg :- swiggy mumbai will have diffrent data as compared to pune swiggy
 *  we have written the ui once and as data comes the ui changes
 *
 *  you sholud always use key.
 *  !Never take index as key in react{Only if the unique id is not given by the backend}
 *
 */

//way of writing inline style in react not prefreable
// const styleCard = {
...
//Pros - property can be used to create the card dynamically
    ...
    <div className="body">
      <div className="search">
        <img
          ...
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-F7MaHBb5svIyHoLNaLDcBMf2la_oT9Xw8-1z2LA&s"
          alt="search-icon"
        />
        search
      </div>
